  ...
  return (
    <>
      ...
      <Helmet>
        ...
        />
        <meta property="og:title" content="Ajinkya Inamdar - Digital Portfolio & CV" />
        <meta 
          property="og:description" 
          content="Explore Ajinkya Inamdar's portfolio featuring projects, skills, certifications, and experience in AI, leadership, and health-tech."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ajinkyainamdar.vercel.app/cv" />
        <meta property="og:image" content={cert1} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Ajinkya Inamdar - Digital Portfolio & CV" />
        <meta 
          name="twitter:description" 
          content="Discover Ajinkya Inamdar's skills, projects, certifications, and professional experience."
        />
      </Helmet>

      <div className="max-w-6xl mx-auto p-6 pt-28">
        {/* Main H1 for SEO */}
        <h1 className="sr-only">Ajinkya Inamdar - Digital Portfolio, CV, Skills, Projects, Certifications, Work Experience</h1>
      ...
      <div key={cert.id} className="flex flex-col items-center justify-center px-2 sm:px-4 min-h-[400px]">
        ...
        <div className="mt-32">
          <div className="text-left md:text-center mb-12">
            <h2 className="text-xl sm:text-4xl md:text-5xl font-bold text-black">Discover more about me</h2>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-md border-3 border-black shadow-2xl rounded-2xl p-6 sm:p-10 space-y-12">
            <div>
              <h3 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4 border-2 border-black">Education</h3>
            ...
            <div>
              <h3 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4 mt-10 border-2 border-black">Hobbies & Interests</h3>
            ...
            <div>
              <h3 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4 border-2 border-black">Contact</h3>
