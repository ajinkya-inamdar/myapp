...
<div className="mt-20">
  <h1 className="text-5xl font-bold mb-10 text-center">Digital Portfolio</h1>
  </div>
...
<div className="mt-30">
  ...
  <div className="flex flex-col md:flex-row justify-center items-center gap-10">
    ...
    <div className="bg-blue-100 shadow-xl rounded-lg p-8 w-full max-w-md border-2 border-black hover:scale-105 transition-transform duration-300 hover:bg-blue-100 active:bg-blue-100 cursor-pointer">
      <h3 className="text-2xl font-semibold text-black mb-2 text-center">
        Co-founder, LifeXtension
      </h3>
      <p className="text-lg text-black mb-4 text-center">
