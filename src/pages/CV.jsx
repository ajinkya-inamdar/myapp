...
const CV = () => {
  return (
    ...
    <div className="text-left md:text-center mb-12">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">Ajinkya Inamdar</h1>
      ...
      {/* Main Box */}
      <div className="bg-gray-800 bg-opacity-10 backdrop-blur-md shadow-2xl rounded-2xl p-6 sm:p-10 space-y-12">
        ...
        {/* Experience Section */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4">Experience</h2>

          <div className="mb-6">
            <h3 className="text-xl sm:text-2xl font-bold text-white">Lead Software Developer</h3>
          ...
          <div className="mb-6">
            <h3 className="text-xl sm:text-2xl font-bold text-white">Co-founder</h3>
        ...
        {/* Education Section */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-semibold bg-[#BAFF39] bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4">Education</h2>
        ...
        <div>
          <h2 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4">Certifications</h2>
          <p className="text-white"><strong>Machine Learning Specialization – DeepLearning.AI</strong></p>
        </div>

        {/* Skills Section */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4">Skills</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={index}
                className="bg-white bg-opacity-30 py-2 px-4 rounded-lg shadow-md text-gray-800"
              >
                {skill}
              </div>
            ))}
        ...
        {/* Projects Section */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4 mt-10">Projects</h2>
          <div className="mb-4">
            <p className="text-white font-semibold">Image Paragraph Generation for Attendance</p>
            <p className="text-white">Developed an innovative solution for automating attendance tracking using image processing and natural language generation.</p>
          </div>
          <div className="mb-4">
            <p className="text-white font-semibold">Stock Market Trends Predictions</p>
        ...
        {/* Hobbies Section */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4">Hobbies & Interests</h2>
        ...
        {/* Contact Section */}
        <div>
          <h2 className="text-2xl sm:text-3xl font-semibold bg-white text-gray-800 px-4 sm:px-6 py-2 sm:py-3 mb-4">Contact</h2>
